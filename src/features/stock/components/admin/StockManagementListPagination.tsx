...
import { PAGE_SIZE_OPTIONS, isPageSize, type PageSize } from "@/features/stock/filters";
...
export function StockManagementListPagination({
  page,
  pageSize,
  totalPages,
  onPageChange,
  ...
  return (
    <nav aria-label="Stock list pagination" className="flex items-center gap-2 px-2 py-3">
