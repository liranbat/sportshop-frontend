...
import { PAGE_SIZE_OPTIONS, isPageSize, type PageSize } from "@/features/orders/filters";
...
export function OrderHistoryPagination({
  ...
  return (
    <nav aria-label="Order history pagination" className="flex items-center gap-2 px-2 py-3">
