...
import { PAGE_SIZE_OPTIONS, isPageSize, type PageSize } from "@/features/sessions/filters";
...
export function AdminSessionsListPagination({
  page,
  pageSize,
  totalPages,
  onPageChange,
  ...
  return (
    <nav aria-label="Admin sessions pagination" className="flex items-center gap-2 px-2 py-3">
