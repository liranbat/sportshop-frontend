...
import { PAGE_SIZE_OPTIONS, isPageSize, type PageSize } from "@/features/users/filters";
...
export function AdminUserListPagination({
  ...
  return (
    <nav aria-label="Admin user list pagination" className="flex items-center gap-2 px-2 py-3">
